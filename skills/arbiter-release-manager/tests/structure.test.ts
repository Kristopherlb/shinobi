/**
 * Structural Tests for arbiter-release-manager Skill
 * 
 ...
 * 
 * Test Metadata: TP-arbiter-release-manager-structure-001
 */
...
const SKILL_NAME = 'arbiter-release-manager';

describe(`arbiter-release-manager - Structural Validation`, () => {
  describe('Metadata Validation', () => {
    it('SKILL.md__Exists__HasValidFrontmatter', () => {
      ...
      expect(content).toMatch(/^name:\s*arbiter-release-manager/m);
