/**
 * Structural Tests for test-driven-development Skill
 * 
 ...
 * 
 * Test Metadata: TP-test-driven-development-structure-001
 */
...
const SKILL_NAME = 'test-driven-development';

describe(`test-driven-development - Structural Validation`, () => {
  describe('Metadata Validation', () => {
    it('SKILL.md__Exists__HasValidFrontmatter', () => {
      ...
      expect(content).toMatch(/^name:\s*test-driven-development/m);
