module.exports = {
  ...
  moduleNameMapper: {
    ...
    // Shinobi aliases - match TypeScript paths exactly
    ...
    // Binder aliases - these modules don't exist yet, so we'll mock them
    '^@binders/(.+)$': '<rootDir>/tests/__mocks__/binders/$1.ts',

    // Fix duplicate observability-handlers issue
  ...
  // Ensure SWC is used for coverage
  coverageProvider: 'v8',
};
