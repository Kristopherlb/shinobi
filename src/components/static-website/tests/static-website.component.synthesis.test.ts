/**
 * StaticWebsiteComponent Component Synthesis Test Suite
...
import { StaticWebsiteConfig } from '../static-website.builder';
...
const createMockSpec = (config: Partial<StaticWebsiteConfig> = {}): ComponentSpec => ({
...
const synthesizeComponent = (
  ...
  spec: ComponentSpec
): { component: StaticWebsiteComponentComponent; template: Template } => {
  const app = new App();
  const stack = new Stack(app, 'TestStack');
  
  const component = new StaticWebsiteComponentComponent(stack, spec, context);
  component.synth();
...
describe('StaticWebsiteComponentComponent Synthesis', () => {
  
  describe('Default Happy Path Synthesis', () => {
    
    it('should synthesize basic static-website with commercial compliance', () => {
