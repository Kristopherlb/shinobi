/**
 * StaticWebsiteComponent ConfigBuilder Test Suite
 * Implements Platform Testing Standard v1.0 - ConfigBuilder Testing
 */

import { StaticWebsiteComponentConfigBuilder, StaticWebsiteConfig } from '../static-website.builder';
...
describe('StaticWebsiteComponentConfigBuilder', () => {
  ...
  describe('Hardcoded Fallbacks (Layer 1)', () => {
    ...
    it('should provide ultra-safe baseline configuration', () => {
      ...
      const builder = new StaticWebsiteComponentConfigBuilder(context, spec);
