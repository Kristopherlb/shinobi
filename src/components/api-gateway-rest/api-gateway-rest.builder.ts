/**
 * Configuration Builder for ApiGatewayRestComponent Component
 * 
...
/**
 * Configuration interface for ApiGatewayRestComponent component
 */
...
/**
 * JSON Schema for ApiGatewayRestComponent configuration validation
 */
...
/**
 * ConfigBuilder for ApiGatewayRestComponent component
 * 
 ...
 */
export class ApiGatewayRestComponentConfigBuilder extends ConfigBuilder<ApiGatewayRestConfig> {
  
  /**
   * Layer 1: Hardcoded Fallbacks
   * Ultra-safe baseline configuration that works in any environment
   */
  protected getHardcodedFallbacks(): Partial<ApiGatewayRestConfig> {
    return {
      monitoring: {
        enabled: true,
  ...
  protected getComplianceFrameworkDefaults(): Partial<ApiGatewayRestConfig> {
    ...
    const baseCompliance: Partial<ApiGatewayRestConfig> = {
      monitoring: {
        enabled: true,
  ...
  public getSchema(): any {
    return API_GATEWAY_REST_CONFIG_SCHEMA;
  }
}