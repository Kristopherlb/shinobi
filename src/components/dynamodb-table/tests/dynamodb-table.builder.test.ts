/**
 * DynamoDbTableComponent ConfigBuilder Test Suite
 * Implements Platform Testing Standard v1.0 - ConfigBuilder Testing
 */

import { DynamoDbTableComponentConfigBuilder, DynamoDbTableConfig } from '../dynamodb-table.builder';
...
describe('DynamoDbTableComponentConfigBuilder', () => {
  ...
  describe('Hardcoded Fallbacks (Layer 1)', () => {
    ...
    it('should provide ultra-safe baseline configuration', () => {
      ...
      const builder = new DynamoDbTableComponentConfigBuilder(context, spec);
