/**
 * AutoScalingGroupComponent Component Synthesis Test Suite
...
import { AutoScalingGroupConfig } from '../auto-scaling-group.builder';
...
const synthesizeComponent = (
  ...
  spec: ComponentSpec
): { component: AutoScalingGroupComponentComponent; template: Template } => {
  const app = new App();
  const stack = new Stack(app, 'TestStack');
  
  const component = new AutoScalingGroupComponentComponent(stack, spec, context);
  component.synth();
...
describe('AutoScalingGroupComponentComponent Synthesis', () => {
  
  describe('Default Happy Path Synthesis', () => {
    
    it('should synthesize basic auto-scaling-group with commercial compliance', () => {
