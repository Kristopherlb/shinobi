 ...
 */
export class EcsEc2ServiceComponentConfigBuilder extends ConfigBuilder<EcsEc2ServiceConfig> {
  ...
  protected getComplianceFrameworkDefaults(): Partial<EcsEc2ServiceConfig> {
    ...
    const baseCompliance: Partial<EcsEc2ServiceConfig> = {
      monitoring: {
        enabled: true,
  ...
  public getSchema(): any {
    return ECS_EC2_SERVICE_CONFIG_SCHEMA;
  }
}