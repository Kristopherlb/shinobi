/**
 * StepFunctionsStateMachineComponent Component Synthesis Test Suite
...
const synthesizeComponent = (
  ...
  spec: ComponentSpec
): { component: StepFunctionsStateMachineComponentComponent; template: Template } => {
  const app = new App();
  const stack = new Stack(app, 'TestStack');
  
  const component = new StepFunctionsStateMachineComponentComponent(stack, spec, context);
  component.synth();
...
describe('StepFunctionsStateMachineComponentComponent Synthesis', () => {
  
  describe('Default Happy Path Synthesis', () => {
    
    it('should synthesize basic step-functions-statemachine with commercial compliance', () => {
