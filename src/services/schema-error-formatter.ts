...
export class SchemaErrorFormatter {
  private static readonly ERROR_MESSAGES: Record<string, (error: ErrorObject) => FormattedError> = {
   ...
   */
  public static formatErrors(errors: ErrorObject[]): FormattedError[] {
   ...
   */
  private static formatError(error: ErrorObject): FormattedError {
   ...
   */
  private static formatPath(instancePath: string): string {
   ...
   */
  private static getFieldName(instancePath: string): string {
   ...
   */
  private static getRequiredFieldSuggestion(field: string): string {
   ...
   */
  private static getArraySuggestion(path: string, minItems: number): string {
   ...
   */
  private static getPatternSuggestion(path: string, pattern: string): string {
   ...
   */
  public static generateErrorReport(errors: ErrorObject[], format: 'human' | 'json' = 'human'): string {
   ...
   */
  private static groupErrorsByPath(errors: FormattedError[]): Record<string, FormattedError[]> {
