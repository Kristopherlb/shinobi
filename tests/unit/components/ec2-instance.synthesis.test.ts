...
describe('EC2 Instance Component', () => {
  ...
  describe('Component Synthesis', () => {
    ...
    it('should configure instance for compliance monitoring', () => {
      ...
      // Success! LaunchTemplate approach works correctly
      
      // Check if MetadataOptions is set on LaunchTemplate instead of Instance
      ...
      // Verify SSM managed policy is attached (CDK uses Fn::Join for ARNs)
      template.hasResourceProperties('AWS::IAM::Role', {
  ...
  describe('Compliance Hardening', () => {
    ...
    it('should apply FedRAMP High hardening with additional security', () => {
      ...
      // Should have STIG compliance tags (test individually)
      template.hasResourceProperties('AWS::EC2::Instance', {
