...
const cloudformation_analyzer_1 = require("./cloudformation-analyzer");
const resource_mapper_1 = require("./resource-mapper");
const logical_id_preserver_1 = require("./logical-id-preserver");
const migration_validator_1 = require("./migration-validator");
const migration_reporter_1 = require("./migration-reporter");
...
class MigrationEngine {
    ...
    constructor(logger) {
        this.logger = logger;
        this.analyzer = new cloudformation_analyzer_1.CloudFormationAnalyzer(logger);
        this.mapper = new resource_mapper_1.ResourceMapper(logger);
        this.preserver = new logical_id_preserver_1.LogicalIdPreserver(logger);
        this.validator = new migration_validator_1.MigrationValidator(logger);
        this.reporter = new migration_reporter_1.MigrationReporter(logger);
    }
    /**
