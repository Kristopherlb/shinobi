...
exports.MigrationReporter = void 0;
...
class MigrationReporter {
    ...
    async generateReport(outputDir, analysisResult, mappingResult, validationResult, options) {
        const reportPath = path.join(outputDir, 'MIGRATION_REPORT.md');
        const reportContent = this.buildReport(analysisResult, mappingResult, validationResult, options);
        fs.writeFileSync(reportPath, reportContent);
        this.logger.info(`Migration report generated: ${reportPath}`);
        return reportPath;
    }
    buildReport(analysisResult, mappingResult, validationResult, options) {
...
`;
    ...
    generateExecutiveSummary(analysisResult, mappingResult, validationResult) {
...
${validationResult.diffResult === 'NO CHANGES'
    ...
    generateSuccessfulComponentsList(mappingResult) {
    ...
    generateUnmappableResourcesList(mappingResult) {
    ...
    generateOriginalInventory(analysisResult) {
    ...
    generateMappingResults(mappingResult) {
    ...
    generateValidationResults(validationResult) {
    ...
    generateNextSteps(mappingResult, validationResult) {
        const steps = [];
        if (mappingResult.unmappableResources.length > 0) {
    ...
    generateLogicalIdDetails(validationResult) {
...
exports.MigrationReporter = MigrationReporter;
