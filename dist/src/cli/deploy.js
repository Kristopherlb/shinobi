...
class DeployCommand {
    ...
    async deployInfrastructure(synthesisResult, env, target) {
        ...
        try {
            ...
            try {
                (0, child_process_1.execSync)(`npx cdk bootstrap --require-approval never`, {
                    cwd: tempDir,
                    env: cdkEnv,
                    stdio: 'inherit',
            ...
            const deployOutput = (0, child_process_1.execSync)(`npx cdk deploy --require-approval never --outputs-file outputs.json`, {
                cwd: tempDir,
                env: cdkEnv,
                encoding: 'utf8',
    ...
    generateCdkApp(synthesisResult, env) {
