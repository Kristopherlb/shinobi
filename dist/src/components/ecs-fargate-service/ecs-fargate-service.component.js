...
exports.EcsFargateServiceComponent = exports.EcsFargateServiceConfigBuilder = exports.ECS_FARGATE_SERVICE_CONFIG_SCHEMA = void 0;
 ...
 */
class EcsFargateServiceConfigBuilder extends config_builder_1.ConfigBuilder {
    constructor(context, spec) {
        const builderContext = { context, spec };
        super(builderContext, exports.ECS_FARGATE_SERVICE_CONFIG_SCHEMA);
    }
    /**
...
exports.EcsFargateServiceConfigBuilder = EcsFargateServiceConfigBuilder;
/**
 * ECS Fargate Service Component implementing Component API Contract v1.0 and
 * Platform ECS Service Connect Standard v1.0
 */
class EcsFargateServiceComponent extends component_1.BaseComponent {
    service;
    taskDefinition;
    securityGroup;
    logGroup;
    ...
    synth() {
        ...
        try {
            ...
            this.logError(error, 'ECS Fargate Service synthesis');
            throw error;
        }
    }
    /**
    ...
    validateCpuMemoryCombination() {
        ...
        if (!compatibleMemory[cpu]?.includes(memory)) {
            throw new Error(`Invalid CPU/Memory combination: ${cpu} vCPU with ${memory} MB memory. ` +
     ...
     */
    _configureObservabilityForEcsService() {
        ...
        this.logComponentEvent('observability_configured', `Created 3 CloudWatch alarms for ECS Fargate service monitoring`);
    }
    /**
     * Get CPU alarm threshold based on compliance framework
     */
    getCpuAlarmThreshold(complianceFramework) {
     ...
     */
    getMemoryAlarmThreshold(complianceFramework) {
        switch (complianceFramework) {
            case 'fedramp-high':
    ...
    configureBlueGreenDeployment() {
        ...
        this.logComponentEvent('blue_green_configured', `Configured blue-green deployment with ALB and target groups`);
    }
    /**
...
exports.EcsFargateServiceComponent = EcsFargateServiceComponent;
