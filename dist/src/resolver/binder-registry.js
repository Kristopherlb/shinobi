...
const compute_to_iam_role_strategy_1 = require("../bindings/strategies/compute-to-iam-role.strategy");
const compute_to_security_group_import_strategy_1 = require("../bindings/strategies/compute-to-security-group-import.strategy");
/**
...
class ResolverBinderRegistry extends binding_strategies_1.BinderRegistry {
    ...
    registerEnterpriseStrategies() {
        ...
        this.registerStrategy(new compute_to_iam_role_strategy_1.ComputeToIamRoleBinder());
        // Security Group Import binding strategies
        this.registerStrategy(new compute_to_security_group_import_strategy_1.ComputeToSecurityGroupImportBinder());
