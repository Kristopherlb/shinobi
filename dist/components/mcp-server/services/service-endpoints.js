...
exports.ServiceEndpointsService = void 0;
/**
 * Service Endpoints Service
 */
class ServiceEndpointsService {
    /**
     * GET /services
     ...
     */
    async getServiceManifest(serviceName) {
     ...
     */
    async getServiceLogs(serviceName, limit = 100, startTime) {
        ...
        return logs.filter(log => serviceName === 'user-management' ? ['user-api', 'user-db'].includes(log.component) :
            serviceName === 'order-processing' ? ['order-worker', 'order-queue'].includes(log.component) :
                false).slice(0, limit);
    }
}
exports.ServiceEndpointsService = ServiceEndpointsService;
