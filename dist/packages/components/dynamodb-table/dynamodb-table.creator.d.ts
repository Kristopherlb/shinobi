 ...
 */
export declare class DynamoDbTableComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "dynamodb-table";
    /**
     * Component display name
     */
    readonly displayName = "Dynamo Db Table Component";
    /**
     * Component description
     */
    readonly description = "DynamoDB Table Component implementing Component API Contract v1.0";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): DynamoDbTableComponentComponent;
    /**
