 ...
 */
export declare class IamPolicyComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "iam-policy";
    /**
     * Component display name
     */
    readonly displayName = "Iam Policy Component";
    /**
     * Component description
     */
    readonly description = "IAM Policy Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): IamPolicyComponentComponent;
    /**
