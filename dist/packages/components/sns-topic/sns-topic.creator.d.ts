 ...
 */
export declare class SnsTopicComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "sns-topic";
    /**
     * Component display name
     */
    readonly displayName = "Sns Topic Component";
    /**
     * Component description
     */
    readonly description = "SNS Topic Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): SnsTopicComponentComponent;
    /**
