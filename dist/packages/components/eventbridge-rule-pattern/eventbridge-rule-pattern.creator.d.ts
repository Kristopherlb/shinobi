 ...
 */
export declare class EventBridgeRulePatternComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "eventbridge-rule-pattern";
    /**
     * Component display name
     */
    readonly displayName = "Event Bridge Rule Pattern Component";
    /**
     * Component description
     */
    readonly description = "EventBridge Rule Pattern Component implementing Component API Contract v1.0";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): EventBridgeRulePatternComponentComponent;
    /**
