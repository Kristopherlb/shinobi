 ...
 */
export declare class IamRoleComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "iam-role";
    /**
     * Component display name
     */
    readonly displayName = "Iam Role Component";
    /**
     * Component description
     */
    readonly description = "IAM Role Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): IamRoleComponentComponent;
    /**
