 ...
 */
export declare class EventBridgeRuleCronComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "eventbridge-rule-cron";
    /**
     * Component display name
     */
    readonly displayName = "Event Bridge Rule Cron Component";
    /**
     * Component description
     */
    readonly description = "EventBridge Rule Cron Component implementing Component API Contract v1.0";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): EventBridgeRuleCronComponentComponent;
    /**
