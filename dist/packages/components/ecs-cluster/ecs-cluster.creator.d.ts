 ...
 */
export declare class EcsClusterComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "ecs-cluster";
    /**
     * Component display name
     */
    readonly displayName = "Ecs Cluster Component";
    /**
     * Component description
     */
    readonly description = "ECS Cluster Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): EcsClusterComponentComponent;
    /**
