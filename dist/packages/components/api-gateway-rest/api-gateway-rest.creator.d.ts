 ...
 */
export declare class ApiGatewayRestComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "api-gateway-rest";
    /**
     * Component display name
     */
    readonly displayName = "Api Gateway Rest Component";
    /**
     * Component description
     */
    readonly description = "Enterprise REST API Gateway Component implementing Component API Contract v1.0";
    /**
     ...
     */
    readonly awsService = "APIGATEWAY";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): ApiGatewayRestComponentComponent;
    /**
