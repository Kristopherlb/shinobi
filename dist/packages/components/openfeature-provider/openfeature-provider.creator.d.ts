 ...
 */
export declare class OpenFeatureProviderComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "openfeature-provider";
    /**
     * Component display name
     */
    readonly displayName = "Open Feature Provider Component";
    /**
     * Component description
     */
    readonly description = "OpenFeature Provider Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): OpenFeatureProviderComponentComponent;
    /**
