...
exports.ApiGatewayHttpCreator = void 0;
const api_gateway_http_component_1 = require("./api-gateway-http.component");
const api_gateway_http_builder_1 = require("./api-gateway-http.builder");
/**
...
class ApiGatewayHttpCreator {
     ...
     */
    displayName = 'Modern HTTP API Gateway';
    /**
     * Component description
     */
    description = 'AWS API Gateway v2 HTTP API for modern, high-performance APIs with cost optimization';
    /**
     ...
     */
    configSchema = api_gateway_http_builder_1.API_GATEWAY_HTTP_CONFIG_SCHEMA;
    /**
    ...
    createComponent(scope, spec, context) {
        return new api_gateway_http_component_1.ApiGatewayHttpComponent(scope, spec, context);
    }
    /**
...
exports.ApiGatewayHttpCreator = ApiGatewayHttpCreator;
