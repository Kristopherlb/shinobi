...
export { ApplicationLoadBalancerConfig, ApplicationLoadBalancerComponentConfigBuilder, APPLICATION_LOAD_BALANCER_CONFIG_SCHEMA } from './application-load-balancer.builder';
