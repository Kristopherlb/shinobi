 ...
 */
export declare class GlueJobComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "glue-job";
    /**
     * Component display name
     */
    readonly displayName = "Glue Job Component";
    /**
     * Component description
     */
    readonly description = "Glue Job Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): GlueJobComponentComponent;
    /**
