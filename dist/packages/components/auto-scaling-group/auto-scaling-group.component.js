...
class AutoScalingGroupComponent extends contracts_1.Component {
    ...
    configureObservabilityForAsg() {
        ...
        this.logComponentEvent('observability_configured', `Configured 2 CloudWatch alarms for ${this.context.complianceFramework} compliance`);
    }
}
