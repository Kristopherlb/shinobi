 ...
 */
export declare class McpServerComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "mcp-server";
    /**
     * Component display name
     */
    readonly displayName = "Mcp Server Component";
    /**
     * Component description
     */
    readonly description = "MCP Server Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): McpServerComponentComponent;
    /**
