 ...
 */
export declare class LambdaApiComponentCreator implements IComponentCreator {
    /**
     ...
     */
    readonly displayName = "Lambda Api Component";
    /**
     * Component description
     */
    readonly description = "Lambda API Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): LambdaApiComponentComponent;
    /**
