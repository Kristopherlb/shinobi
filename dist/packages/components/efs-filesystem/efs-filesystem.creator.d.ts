 ...
 */
export declare class EfsFilesystemComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "efs-filesystem";
    /**
     * Component display name
     */
    readonly displayName = "Efs Filesystem Component";
    /**
     * Component description
     */
    readonly description = "EFS Filesystem Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): EfsFilesystemComponentComponent;
    /**
