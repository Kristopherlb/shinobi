 ...
 */
export declare class LambdaWorkerComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "lambda-worker";
    /**
     * Component display name
     */
    readonly displayName = "Lambda Worker Component";
    /**
     * Component description
     */
    readonly description = "Lambda Worker Component";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): LambdaWorkerComponentComponent;
    /**
