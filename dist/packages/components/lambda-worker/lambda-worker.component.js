...
exports.LambdaWorkerComponent = exports.LambdaWorkerConfigBuilder = exports.LAMBDA_WORKER_CONFIG_SCHEMA = void 0;
 ...
 */
exports.LAMBDA_WORKER_CONFIG_SCHEMA = {
    type: 'object',
 ...
 */
class LambdaWorkerConfigBuilder {
    context;
    spec;
     ...
     */
    getComplianceMemorySize(framework) {
        switch (framework) {
            case 'fedramp-high':
                return 512;
            case 'fedramp-moderate':
     ...
     */
    getComplianceTimeout(framework) {
        switch (framework) {
            case 'fedramp-high':
                return 600;
            case 'fedramp-moderate':
...
exports.LambdaWorkerConfigBuilder = LambdaWorkerConfigBuilder;
/**
 * Lambda Worker Component implementing Component API Contract v1.0
 */
class LambdaWorkerComponent extends contracts_1.Component {
    lambdaFunction;
    kmsKey;
    config;
    ...
    createLambdaFunction() {
        ...
        this.applyStandardTags(this.lambdaFunction, {
            ...
            'runtime': this.getLambdaRuntime().name,
            'memory': (this.config.memory || 256).toString(),
            'timeout': (this.config.timeout || 300).toString()
        });
    }
    /**
     ...
     */
    configureObservabilityForLambda() {
        if (!this.lambdaFunction) {
            return;
        }
...
exports.LambdaWorkerComponent = LambdaWorkerComponent;
