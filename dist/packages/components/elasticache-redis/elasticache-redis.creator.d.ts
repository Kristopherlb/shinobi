 ...
 */
export declare class ElastiCacheRedisComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "elasticache-redis";
    /**
     * Component display name
     */
    readonly displayName = "Elasti Cache Redis Component";
    /**
     * Component description
     */
    readonly description = "ElastiCache Redis Component implementing Component API Contract v1.0";
    /**
     ...
     */
    readonly awsService = "ELASTICACHE";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): ElastiCacheRedisComponentComponent;
    /**
