...
exports.CertificateManagerComponent = exports.CertificateManagerConfigBuilder = exports.CERTIFICATE_MANAGER_CONFIG_SCHEMA = void 0;
 ...
 */
exports.CERTIFICATE_MANAGER_CONFIG_SCHEMA = {
    type: 'object',
 ...
 */
class CertificateManagerConfigBuilder {
    context;
    spec;
...
exports.CertificateManagerConfigBuilder = CertificateManagerConfigBuilder;
/**
 * Certificate Manager Component implementing Component API Contract v1.0
 */
class CertificateManagerComponent extends contracts_1.Component {
    certificate;
    hostedZone;
    config;
     ...
     */
    lookupHostedZoneIfNeeded() {
        if (this.config.validation?.method === 'DNS' && this.config.validation?.hostedZone) {
            this.hostedZone = route53.HostedZone.fromHostedZoneId(this, 'HostedZone', this.config.validation.hostedZone);
        }
    }
    /**
    ...
    createCertificate() {
        ...
        if (this.config.validation?.method === 'DNS' && this.hostedZone) {
            ...
            certificateProps = {
                domainName: this.config.domainName,
                subjectAlternativeNames: this.config.subjectAlternativeNames,
                validation: acm.CertificateValidation.fromEmail(this.config.validation?.validationEmails
                    ? Object.fromEntries([this.config.domainName, ...(this.config.subjectAlternativeNames || [])]
                        .map((domain, index) => [
                        domain,
     ...
     */
    configureObservabilityForCertificate() {
...
exports.CertificateManagerComponent = CertificateManagerComponent;
