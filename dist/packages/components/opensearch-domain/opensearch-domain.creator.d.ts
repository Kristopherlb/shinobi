 ...
 */
export declare class OpenSearchDomainComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "opensearch-domain";
    /**
     * Component display name
     */
    readonly displayName = "Open Search Domain Component";
    /**
     * Component description
     */
    readonly description = "OpenSearch Domain Component";
    /**
     ...
     */
    readonly awsService = "OPENSEARCHSERVICE";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): OpenSearchDomainComponentComponent;
    /**
