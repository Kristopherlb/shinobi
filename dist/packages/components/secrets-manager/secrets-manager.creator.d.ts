 ...
 */
export declare class SecretsManagerComponentCreator implements IComponentCreator {
    /**
     * Component type identifier
     */
    readonly componentType = "secrets-manager";
    /**
     * Component display name
     */
    readonly displayName = "Secrets Manager Component";
    /**
     * Component description
     */
    readonly description = "Secrets Manager Component";
    /**
     ...
     */
    readonly awsService = "SECRETSMANAGER";
    /**
     ...
     */
    createComponent(scope: Construct, spec: ComponentSpec, context: ComponentContext): SecretsManagerComponentComponent;
    /**
