...
exports.VpcLoggingHandler = void 0;
...
class VpcLoggingHandler {
    ...
    apply(component, context) {
        try {
            ...
            return {
                ...
                encryption: { enabled: false, managedKey: true },
                classification: 'internal',
                error: `Failed to configure VPC logging: ${error.message}`
            };
        }
    }
    /**
     ...
     */
    createVpcFlowLogGroup(component, logGroupName, context) {
     ...
     */
    createFlowLogRole(component, logGroup) {
     ...
     */
    configureVpcFlowLogs(component, vpc, logGroup, role, context) {
     ...
     * Apply security monitoring configuration
     */
    applySecurityMonitoring(component, logGroup, context) {
     ...
     */
    getStructuredLogFormatFields(context) {
        const baseFields = [
...
exports.VpcLoggingHandler = VpcLoggingHandler;
