...
class CliApplication {
  ...
  private async handleInitCommand(options: any, globalOptions: GlobalOptions): Promise<void> {
  ...
  private async handleValidateCommand(options: any, globalOptions: GlobalOptions): Promise<void> {
    const dependencies = this.compositionRoot.createDependencies({
      verbose: globalOptions.verbose || false,
      ci: globalOptions.ci || false
    });
  ...
  private async handlePlanCommand(options: any, globalOptions: GlobalOptions): Promise<void> {
    const dependencies = this.compositionRoot.createDependencies({
      verbose: globalOptions.verbose || false,
      ci: globalOptions.ci || false
    });
