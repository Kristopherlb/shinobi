 ...
 */
class LambdaObservabilityHandler {
    supportedComponentType = 'lambda';
    context;
    taggingService;
     ...
     */
    applyLambdaOTelInstrumentation(component, config) {
     ...
     */
    applyLambdaObservability(component, config) {
        const lambdaFunction = component.getConstruct('function');
        if (!lambdaFunction) {
            this.context.logger.warn('Lambda component has no function construct registered', {
                service: 'ObservabilityService'
