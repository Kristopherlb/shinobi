 ...
 */
class AlbObservabilityHandler {
    supportedComponentType = 'application-load-balancer';
    context;
    taggingService;
     ...
     */
    applyAlbObservability(component, config) {
        ...
        const loadBalancerName = loadBalancer.loadBalancerName || component.node.id;
