...
export class SqsObservabilityHandler implements IObservabilityHandler {
   ...
   */
  private applySqsOTelInstrumentation(component: BaseComponent, config: ObservabilityConfig): boolean {
   ...
   */
  private applySqsObservability(component: BaseComponent, config: ObservabilityConfig): number {
