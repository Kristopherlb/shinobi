...
import { LambdaPowertoolsExtensionHandler, LambdaPowertoolsConfig, DEFAULT_POWERTOOLS_CONFIG } from '../src/observability-handlers/lambda-powertools-extension.handler';
