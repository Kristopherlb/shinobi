/**
 * EventBridgeRulePatternComponent Component Synthesis Test Suite
...
const synthesizeComponent = (
  ...
  spec: ComponentSpec
): { component: EventBridgeRulePatternComponentComponent; template: Template } => {
  const app = new App();
  const stack = new Stack(app, 'TestStack');
  
  const component = new EventBridgeRulePatternComponentComponent(stack, spec, context);
  component.synth();
...
describe('EventBridgeRulePatternComponentComponent Synthesis', () => {
  
  describe('Default Happy Path Synthesis', () => {
    
    it('should synthesize basic eventbridge-rule-pattern with commercial compliance', () => {
