...
const synthesizeComponent = (
  ...
  spec: ComponentSpec
): { component: LambdaApiComponentComponent; template: Template } => {
  const app = new App();
  const stack = new Stack(app, 'TestStack');
  
  const component = new LambdaApiComponentComponent(stack, spec, context);
  component.synth();
...
describe('LambdaApiComponentComponent Synthesis', () => {
