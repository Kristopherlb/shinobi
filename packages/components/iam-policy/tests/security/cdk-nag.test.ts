/**
 * CDK Nag Security Tests for IAM Policy Component
 * 
...
describe.skip('IamPolicyComponent - CDK Nag Security Validation', () => {
  ...
  describe('Commercial Framework - AwsSolutions', () => {
    it('passes AwsSolutions security checks for basic IAM policy', () => {
      ...
      const component = new IamPolicyComponentComponent(stack, 'TestPolicy', context, spec);
      component.synth();
