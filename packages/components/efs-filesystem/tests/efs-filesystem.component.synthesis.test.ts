/**
 * EfsFilesystemComponent Component Synthesis Test Suite
...
const synthesizeComponent = (
  ...
  spec: ComponentSpec
): { component: EfsFilesystemComponentComponent; template: Template } => {
  const app = new App();
  const stack = new Stack(app, 'TestStack');
  
  const component = new EfsFilesystemComponentComponent(stack, spec, context);
  component.synth();
...
describe('EfsFilesystemComponentComponent Synthesis', () => {
  
  describe('Default Happy Path Synthesis', () => {
    
    it('should synthesize basic efs-filesystem with commercial compliance', () => {
