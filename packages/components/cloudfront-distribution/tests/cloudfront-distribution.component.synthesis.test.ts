/**
 * CloudFrontDistributionComponent Component Synthesis Test Suite
...
const synthesizeComponent = (
  ...
  spec: ComponentSpec
): { component: CloudFrontDistributionComponentComponent; template: Template } => {
  const app = new App();
  const stack = new Stack(app, 'TestStack');
  
  const component = new CloudFrontDistributionComponentComponent(stack, spec, context);
  component.synth();
...
describe('CloudFrontDistributionComponentComponent Synthesis', () => {
  
  describe('Default Happy Path Synthesis', () => {
    
    it('should synthesize basic cloudfront-distribution with commercial compliance', () => {
      ...
      expect(component.getType()).toBe('cloudfront-distribution');
    });
