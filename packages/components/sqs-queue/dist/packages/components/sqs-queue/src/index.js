...
exports.SqsQueueComponent = exports.SqsQueueConfigBuilder = exports.SQS_QUEUE_CONFIG_SCHEMA = void 0;
 ...
 */
exports.SQS_QUEUE_CONFIG_SCHEMA = {
    type: 'object',
...
exports.SqsQueueConfigBuilder = SqsQueueConfigBuilder;
/**
 * SQS Queue Component implementing Component API Contract v1.0
 */
class SqsQueueComponent extends contracts_1.Component {
    queue;
    deadLetterQueue;
    kmsKey;
    config;
    ...
    createQueue() {
        const queueProps = {
            ...
            retentionPeriod: cdk.Duration.seconds(this.config.messageRetentionPeriod || 345600),
     ...
     */
    configureObservabilityForQueue() {
        if (!this.queue)
            return;
...
exports.SqsQueueComponent = SqsQueueComponent;
