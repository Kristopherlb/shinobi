 ...
 */
export class LambdaWorkerComponentCreator implements IComponentCreator {
  
  /**
   * Component type identifier
   */
  public readonly componentType = 'lambda-worker';
  
  /**
   * Component display name
   */
  public readonly displayName = 'Lambda Worker Component';
  
  /**
   * Component description
   */
  public readonly description = 'Lambda Worker Component';
   ...
   */
  public readonly configSchema = LAMBDA_WORKER_CONFIG_SCHEMA;
  ...
  public validateSpec(
    ...
    const errors: string[] = [];
    const config = spec.config as LambdaWorkerConfig;
