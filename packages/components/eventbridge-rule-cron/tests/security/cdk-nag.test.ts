...
import { EventBridgeRuleCronComponentConfigBuilder } from '../../eventbridge-rule-cron.builder';
...
describe.skip('EventBridgeRuleCronComponent - CDK Nag Security Validation', () => {
  let app: cdk.App;
  let stack: cdk.Stack;
