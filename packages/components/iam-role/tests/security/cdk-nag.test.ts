/**
 * CDK Nag Security Tests for IAM Role Component
 * 
...
describe.skip('IamRoleComponent - CDK Nag Security Validation', () => {
  ...
  describe('Commercial Framework - AwsSolutions', () => {
    it('passes AwsSolutions security checks for basic IAM role', () => {
      ...
      const component = new IamRoleComponent(stack, 'TestRole', context, spec);
      component.synth();
    ...
    it('passes AwsSolutions security checks with highRiskEnvironment enabled', () => {
      const spec: ComponentSpec = {
        ...
        config: {
          ...
          permissionsBoundary: 'arn:aws:iam::123456789012:policy/boundary-policy'
        }
      };
