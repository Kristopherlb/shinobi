...
export { S3BucketComponent } from './s3-bucket.component.js';

export {
  S3BucketComponentConfigBuilder,
  S3_BUCKET_CONFIG_SCHEMA
} from './s3-bucket.builder.js';
export type { S3BucketConfig } from './s3-bucket.builder.js';

export { S3BucketComponentCreator } from './s3-bucket.creator.js';
