...
export declare abstract class BaseComponent extends Construct implements IComponent {
    ...
    private governanceMetadataCache?;
    /**
     ...
     */
    constructor(scope: Construct, id: string, context: ComponentContext, spec: ComponentSpec, services?: Partial<BaseComponentServices>);
    /**
