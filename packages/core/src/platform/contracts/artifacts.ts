 ...
 * 
 * Defines the output artifacts and contracts for shinobi plan, shinobi up, and shinobi migrate commands.
...
export interface ComponentPlanArtifact {
  ...
  compliancePlan?: string; // Path to compliance plan file
  dependencies: string[];
...
export interface LogicalIdMapping {
  version: string;
  mappings: Record<string, string>; // originalId -> newId
  reverse: Record<string, string>; // newId -> originalId
  components: Record<string, string>; // logicalId -> componentId
}
...
export interface MigrationArtifacts {
  serviceManifest: string; // Path to generated service.yml
  logicalIdMap: string; // Path to logical-id-map.json
  migrationReport: string; // Path to MIGRATION_REPORT.md
  patchesFile: string; // Path to patches.ts
  srcDirectory: string; // Path to copied src/ directory
}

// =============================================================================
// SUMMARY AND VALIDATION ARTIFACTS
// =============================================================================
