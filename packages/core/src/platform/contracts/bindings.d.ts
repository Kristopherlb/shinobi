...
export type Capability = DbCapability | StorageCapability | QueueCapability | CacheCapability | LambdaCapability | ApiCapability | MonitoringCapability | AIProviderCapabilityType;
/**
...
export type CapabilityData = PostgresCapabilityData | MySQLCapabilityData | S3CapabilityData | SQSCapabilityData | SNSCapabilityData | RedisCapabilityData | LambdaCapabilityData | ApiGatewayCapabilityData | AIProviderCapabilityData | CustomCapabilityData;
export type SgPeer = {
    kind: 'sg';
    id: string;
} | {
