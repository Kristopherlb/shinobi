 ...
 */
export function getDirectiveSchema(capability) {
 ...
 */
export function getEnvAllowList(capability) {
 ...
 */
export function registerDirectiveSchema(capability, schema) {
 ...
 */
export function registerEnvAllowList(capability, allowList) {
    envAllowLists[capability] = allowList;
}
//# sourceMappingURL=directive-schemas.js.map