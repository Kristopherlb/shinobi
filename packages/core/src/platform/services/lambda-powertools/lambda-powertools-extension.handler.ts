 ...
 */
export const DEFAULT_POWERTOOLS_CONFIG: Required<LambdaPowertoolsConfig> = {
  enabled: false,
  layerArn: '',
  enableLogger: true,
  enableTracer: true,
...
export class LambdaPowertoolsExtensionHandler {
  private config: Required<LambdaPowertoolsConfig>;
   ...
   */
  public getPowertoolsConfig(): Required<LambdaPowertoolsConfig> {
    return { ...this.config };
  }
   ...
   */
  private applyPowertoolsLayer(lambdaFunction: lambda.Function): void {
   ...
   */
  private applyIamPermissions(lambdaFunction: lambda.Function): void {
