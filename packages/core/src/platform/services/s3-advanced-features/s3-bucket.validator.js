...
export class S3BucketValidator {
    ...
    validateBucketName(errors, warnings) {
    ...
    validateCompliance(errors, warnings) {
    ...
    validateLifecycleRules(errors, warnings) {
    ...
    validateMonitoring(errors, warnings) {
    ...
    validateFrameworkCompliance(errors, warnings) {
        const compliance = {
            commercial: true,
