...
export class ComplianceControlMappingService {
    ...
    generateCompliancePlan(componentId, componentType, framework, componentConfig) {
        ...
        const controls = mapping.controls.map(controlId => this.getNISTControl(controlId)).filter(Boolean);
     ...
     */
    generateRequiredTags(componentId, componentType, framework, componentConfig) {
        const tags = {
     ...
     */
    validateCompliance(component, framework) {
    ...
    getSupportedComponentTypes() {
        return Object.keys(CONTROL_MAPPINGS);
    }
    /**
...
//# sourceMappingURL=compliance-control-mapping.js.map