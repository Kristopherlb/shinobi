 ...
 */
export function applySecurityGroupTags(securityGroup, options = {}) {
    const tags = {
        'resource-type': 'security-group',
 ...
 */
export function validateSecurityGroupTags(securityGroup) {
    const requiredTags = [
        'resource-type',
        'ingress-policy'
    ];
 ...
 */
export function getSecurityGroupTaggingDocumentation() {
    return `
...
//# sourceMappingURL=security-group-tagging.js.map