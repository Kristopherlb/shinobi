    ...
    register(strategy) {
        for (const capability of strategy.supportedCapabilities) {
            ...
            if (this.strategies.has(capability)) {
                console.warn(`Capability '${capability}' already registered. ` +
...
//# sourceMappingURL=unified-binder-registry.js.map