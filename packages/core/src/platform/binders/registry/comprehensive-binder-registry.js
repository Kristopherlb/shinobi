...
import { CognitoUserPoolBinderStrategy } from '../strategies/security/cognito-user-pool-binder-strategy.js';
// ML Services
...
export class ComprehensiveBinderRegistry {
    ...
    validateBinding(serviceType, capability) {
        const strategy = this.strategies.get(serviceType);
        if (!strategy) {
            return false;
        }
    ...
    getBindingRecommendations(serviceType) {
...
//# sourceMappingURL=comprehensive-binder-registry.js.map