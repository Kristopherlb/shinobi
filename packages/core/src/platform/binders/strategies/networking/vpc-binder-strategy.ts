...
export class VpcBinderStrategy implements IBinderStrategy {
  ...
  private async bindToSecurityGroup(
    sourceComponent: any,
    targetComponent: any,
    binding: ComponentBinding,
    context: BindingContext
    ...
    if (targetComponent.securityGroupRules) {
      sourceComponent.addEnvironment('SECURITY_GROUP_INGRESS_RULES',
        JSON.stringify(targetComponent.securityGroupRules.filter((rule: any) => rule.isEgress === false)));
      sourceComponent.addEnvironment('SECURITY_GROUP_EGRESS_RULES',
        JSON.stringify(targetComponent.securityGroupRules.filter((rule: any) => rule.isEgress === true)));
    }
  }

  private async bindToRouteTable(
    sourceComponent: any,
    targetComponent: any,
    binding: ComponentBinding,
    context: BindingContext
  ...
  private async bindToNatGateway(
    sourceComponent: any,
    targetComponent: any,
    binding: ComponentBinding,
    context: BindingContext
