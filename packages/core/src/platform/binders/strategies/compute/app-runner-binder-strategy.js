 ...
 */
export class AppRunnerBinderStrategy {
    supportedCapabilities = ['apprunner:service', 'apprunner:connection'];
    ...
    async configureSecureNetworking(sourceComponent, targetComponent, context) {
...
//# sourceMappingURL=app-runner-binder-strategy.js.map