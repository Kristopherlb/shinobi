...
export class StepFunctionsBinderStrategy {
    supportedCapabilities = ['states:state-machine', 'states:execution', 'states:activity'];
    ...
    async bindToStateMachine(sourceComponent, targetComponent, binding, context) {
    ...
    async bindToExecution(sourceComponent, targetComponent, binding, context) {
        const { access } = binding;
    ...
    async bindToActivity(sourceComponent, targetComponent, binding, context) {
        const { access } = binding;
    ...
    async configureSecureStateMachineAccess(sourceComponent, targetComponent, context) {
        // Configure logging
        ...
        if (targetComponent?.enableEncryption === true) {
...
//# sourceMappingURL=step-functions-binder-strategy.js.map