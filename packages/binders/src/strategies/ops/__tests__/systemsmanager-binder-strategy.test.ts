...
describe('SystemsManagerBinderStrategy', () => {
  describe('SystemsManagerBind__ValidAccess__ReturnsEnhancedResult', () => {
    const metadata = {
      ...
      naming: { pattern: 'SystemsManagerBind__Condition__Outcome', example: 'SystemsManagerBind__ValidAccess__ReturnsEnhancedResult' },
      invariants: [
      ...
      inputs: {
        shape: 'BindingContext with ops:ssm-automation capability',
    ...
    test('SystemsManagerBind__ValidAccess__ReturnsEnhancedResult', async () => {
