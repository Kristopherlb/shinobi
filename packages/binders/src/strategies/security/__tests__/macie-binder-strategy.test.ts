...
describe('MacieBinderStrategy', () => {
  describe('MacieBind__ValidAccess__ReturnsEnhancedResult', () => {
    const metadata = {
      ...
      naming: { pattern: 'MacieBind__Condition__Outcome', example: 'MacieBind__ValidAccess__ReturnsEnhancedResult' },
      invariants: [
      ...
      inputs: {
        shape: 'BindingContext with security:macie-job capability',
    ...
    test('MacieBind__ValidAccess__ReturnsEnhancedResult', async () => {
