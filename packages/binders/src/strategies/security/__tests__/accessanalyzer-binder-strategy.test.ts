...
describe('AccessAnalyzerBinderStrategy', () => {
  describe('AccessAnalyzerBind__ValidAccess__ReturnsEnhancedResult', () => {
    const metadata = {
      ...
      naming: { pattern: 'AccessAnalyzerBind__Condition__Outcome', example: 'AccessAnalyzerBind__ValidAccess__ReturnsEnhancedResult' },
      invariants: [
      ...
      inputs: {
        shape: 'BindingContext with security:access-analyzer capability',
    ...
    test('AccessAnalyzerBind__ValidAccess__ReturnsEnhancedResult', async () => {
