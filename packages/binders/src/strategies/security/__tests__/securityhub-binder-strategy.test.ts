...
describe('SecurityHubBinderStrategy', () => {
  describe('SecurityHubBind__ValidAccess__ReturnsEnhancedResult', () => {
    const metadata = {
      ...
      naming: { pattern: 'SecurityHubBind__Condition__Outcome', example: 'SecurityHubBind__ValidAccess__ReturnsEnhancedResult' },
      invariants: [
      ...
      inputs: {
        shape: 'BindingContext with security:securityhub-hub capability',
    ...
    test('SecurityHubBind__ValidAccess__ReturnsEnhancedResult', async () => {
