...
export class MacieBinderStrategy extends UnifiedBinderStrategyBase {
    ...
    return [
      {
        ...
        description: 'TODO: Add description for security:macie-job binding',
  ...
  protected async doBind(context: BindingContext): Promise<Omit<EnhancedBindingResult, 'compliance'>> {
    ...
    return await this.bindToMacie-job(context, targetCapabilityData);
  }
  ...
  private async bindToMacie-job(
    ...
    //       new PolicyStatement({
    //         effect: Effect.ALLOW,
    //         actions: ['security:macie-job:Get*', 'security:macie-job:Describe*'],
