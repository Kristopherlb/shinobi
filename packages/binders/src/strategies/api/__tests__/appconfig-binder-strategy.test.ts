...
describe('AppConfigBinderStrategy', () => {
  describe('AppConfigBind__ValidAccess__ReturnsEnhancedResult', () => {
    const metadata = {
      ...
      naming: { pattern: 'AppConfigBind__Condition__Outcome', example: 'AppConfigBind__ValidAccess__ReturnsEnhancedResult' },
      invariants: [
      ...
      inputs: {
        shape: 'BindingContext with config:appconfig capability',
    ...
    test('AppConfigBind__ValidAccess__ReturnsEnhancedResult', async () => {
