...
describe('CloudWatchBinderStrategy', () => {
  describe('CloudWatchBind__ValidAccess__ReturnsEnhancedResult', () => {
    const metadata = {
      ...
      naming: { pattern: 'CloudWatchBind__Condition__Outcome', example: 'CloudWatchBind__ValidAccess__ReturnsEnhancedResult' },
      invariants: [
      ...
      inputs: {
        shape: 'BindingContext with monitoring:cloudwatch-dashboard capability',
    ...
    test('CloudWatchBind__ValidAccess__ReturnsEnhancedResult', async () => {
      ...
      const target = createMockTargetComponent('test-target', {
        'monitoring:cloudwatch-dashboard': {
          type: 'monitoring:cloudwatch-dashboard',
          resources: {
