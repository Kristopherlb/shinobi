...
import { MigrationEngine, Logger as CoreEngineLogger } from '@shinobi/core';
import { Logger } from './utils/logger.js';
import * as fs from 'fs';
const format = (value) => (value ?? '').toString();
const chalk = {
    bold: (value) => format(value),
    cyan: (value) => format(value),
    green: (value) => format(value),
    yellow: (value) => format(value),
    red: (value) => format(value),
    dim: (value) => format(value)
};
